...
public class RemoteCourse extends Course {
  ...
  @Expose @SerializedName("additional_materials_update_date") private Date myAdditionalMaterialsUpdateDate = new Date(0);
  ...
  public void setAdditionalMaterialsUpdateDate(Date additionalMaterialsUpdateDate) {
